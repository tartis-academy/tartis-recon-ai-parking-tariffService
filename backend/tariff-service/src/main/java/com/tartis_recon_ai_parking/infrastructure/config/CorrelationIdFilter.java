 ...
 * del servicio directamente ({@code localhost:8082}) sin pasar por el gateway,
 * que es lo que hace el equipo para depurar: tambien esas peticiones deben ser
 * trazables.
 *
 ...
 * Ese segundo filtro depende de SEC-07 (el arranque del resource server), que
 * todavia no esta en release.
 *
