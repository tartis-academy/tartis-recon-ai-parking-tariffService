...
public class TransactionalDeactivateTariffUseCase extends DeactivateTariffUseCase {

    public TransactionalDeactivateTariffUseCase(TariffPersistence tariffPersistence, TariffEventPublisher eventPublisher) {
